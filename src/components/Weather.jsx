...
const Weather = () => {
  ...
  try {
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=e1bfa891da06bd702df3630d692dcd0a&units=metric`;
    ...
    //Update the state so it shows on your page
    setWeatherData({
